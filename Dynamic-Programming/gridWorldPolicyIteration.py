...
optimal_policy, optimal_value = policyIteration(P,R,gamma,theta,initial_policy,10000)
initial_v = np.zeros(16)
opt_actions,opt_v = valueIteration(P,R,gamma,theta,initial_v,10000)
